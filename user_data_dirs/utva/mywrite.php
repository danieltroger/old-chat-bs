...
<input type="hidden" name="name" value="utva/chatt.htm" />
<input type="hidden" name="ud" value="utva/" />
...
<textarea name="ett" id="nna" cols="30" rows="9"></textarea>
<input type="hidden" id="n" name="name" value="uett/chatt.htm" />
<input type="hidden" id="u" name="ud" value="uett/" />
...
function send()
{
   // setTimeout("document.getElementById('myf2').submit();",0);
    var msg1=document.getElementById("nna").value;
...
var ta22=document.getElementById('nna');
</script>
